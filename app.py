...
def hello():
    ...
    try:
        ...
        for item in Datadict['tracks']['items']:
            ...
            artists = artists[:-2]
            Id = item['id']
            html += "<tr height="120"><td><image src="+albumart+' height="100" width="100"/></td><td>'+name+"</td><td>"+album+"</td><td>"+artists+'</td><td><audio controls style="width: 300px;"><source src="'+preview+'" type="audio/mpeg"></td><td><a href="/vote?id='+Id+'" class="button fit">Vote</a></td></tr>'
            tot+="\nTrack Name: "+name+"\nalbum name: "+album+'\nalbum art: <img src="'+albumart+'"/>\nartists: '+artists+"\nId: "+Id+"\n"
        html += '''
        </tbody>
    </table>
